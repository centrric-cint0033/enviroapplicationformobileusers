...
mixin _$OhsNewsViewModel on OhsNewsViewModelBase, Store {
  late final _$newspageResponseAtom =
      Atom(name: 'OhsNewsViewModelBase.newspageResponse', context: context);
  ...
  late final _$ohsnewsviewmodelfunctionAsyncAction = AsyncAction(
      'OhsNewsViewModelBase.ohsnewsviewmodelfunction',
      context: context);
