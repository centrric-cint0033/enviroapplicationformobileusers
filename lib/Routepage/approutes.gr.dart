...
abstract class $AppRouter extends _i31.RootStackRouter {
  ...
  final Map<String, _i31.PageFactory> pagesMap = {
    ...
    SheduledetailRoute.name: (routeData) {
      return _i31.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i21.SheduledetailPage(),
      );
    },
...
/// generated route for
/// [_i2.CalenderPage]
class CalenderRoute extends _i31.PageRouteInfo<void> {
  const CalenderRoute({List<_i31.PageRouteInfo>? children})
      : super(
          CalenderRoute.name,
          initialChildren: children,
        );
...
class SheduledetailRoute extends _i31.PageRouteInfo<void> {
  const SheduledetailRoute({List<_i31.PageRouteInfo>? children})
      : super(
