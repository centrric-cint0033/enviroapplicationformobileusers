...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.IAllSemiTrailorPageService>(
        () => _i13.SemiTrailorPageService());
    gh.lazySingleton<_i14.IAllVehicleListService>(
        () => _i15.AllVehicleListRepository());
    gh.lazySingleton<_i16.IAuthService>(() => _i17.AuthRepository());
    gh.lazySingleton<_i18.IHomeService>(() => _i19.HomeRepository());
    gh.factory<_i20.LoginViewModel>(
        () => _i20.LoginViewModel(gh<_i16.IAuthService>()));
    gh.factory<_i21.QuoteRegPageViewModel>(
        () => _i21.QuoteRegPageViewModel(gh<_i10.IAllQuoteRegService>()));
    gh.lazySingleton<_i22.SecureStorage>(() => _i22.SecureStorage());
    gh.factory<_i23.SemiTrailorPageViewModel>(() =>
        _i23.SemiTrailorPageViewModel(gh<_i12.IAllSemiTrailorPageService>()));
    gh.factory<_i24.TruckPageViewModel>(
        () => _i24.TruckPageViewModel(gh<_i6.IAllMasterTruckPageService>()));
    gh.factory<_i25.AllVehiclelistviewModel>(
        () => _i25.AllVehiclelistviewModel(gh<_i14.IAllVehicleListService>()));
    gh.factory<_i26.CarPageViewModel>(
        () => _i26.CarPageViewModel(gh<_i8.IAllMastercarService>()));
    gh.factory<_i27.HomeViewModel>(
        () => _i27.HomeViewModel(gh<_i18.IHomeService>()));
    return this;
  }
}
