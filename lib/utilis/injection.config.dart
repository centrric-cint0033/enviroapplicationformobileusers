...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i14.SalesViewModel>(
        () => _i14.SalesViewModel(gh<_i12.ISalesService>()));
    gh.lazySingleton<_i15.SecureStorage>(() => _i15.SecureStorage());
    gh.factory<_i16.VehicleViewModel>(
        () => _i16.VehicleViewModel(gh<_i13.IVehicleService>()));
    gh.factory<_i17.AuthViewModel>(
        () => _i17.AuthViewModel(gh<_i8.IAuthService>()));
    gh.factory<_i18.HomeViewModel>(
        () => _i18.HomeViewModel(gh<_i10.IHomeService>()));
    return this;
  }
}
