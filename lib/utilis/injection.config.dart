...
import 'package:enviro_mobile_application/Routepage/securestorage.dart' as _i40;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i34.LoginViewModel>(
        () => _i34.LoginViewModel(gh<_i30.IAuthService>()));
    gh.factory<_i35.OhsNewsFolderViewModel>(
        () => _i35.OhsNewsFolderViewModel(gh<_i14.IAllOhsNewsFolderService>()));
    gh.factory<_i36.OhsNewsViewModel>(
        () => _i36.OhsNewsViewModel(gh<_i16.IAllOhsService>()));
    gh.factory<_i37.OhsNotificationViewModel>(() =>
        _i37.OhsNotificationViewModel(gh<_i12.IAllNotificationService>()));
    gh.factory<_i38.QuoteRegPageViewModel>(
        () => _i38.QuoteRegPageViewModel(gh<_i20.IAllQuoteRegService>()));
    gh.factory<_i39.SalesPerformanceViewModel>(
        () => _i39.SalesPerformanceViewModel(gh<_i24.IAllSalesService>()));
    gh.lazySingleton<_i40.SecureStorage>(() => _i40.SecureStorage());
    gh.factory<_i41.SemiTrailorPageViewModel>(() =>
        _i41.SemiTrailorPageViewModel(gh<_i26.IAllSemiTrailorPageService>()));
    gh.factory<_i42.TruckPageViewModel>(
        () => _i42.TruckPageViewModel(gh<_i8.IAllMasterTruckPageService>()));
    gh.factory<_i43.VehicleJobListViewModel>(
        () => _i43.VehicleJobListViewModel(gh<_i22.IAllSalesJobPageService>()));
    gh.factory<_i44.AllVehiclelistviewModel>(
        () => _i44.AllVehiclelistviewModel(gh<_i28.IAllVehicleListService>()));
    gh.factory<_i45.CarPageViewModel>(
        () => _i45.CarPageViewModel(gh<_i10.IAllMastercarService>()));
    gh.factory<_i46.FolderCreationViewModel>(() =>
        _i46.FolderCreationViewModel(gh<_i6.IAllFolderCreationService>()));
    gh.factory<_i47.HomeViewModel>(
        () => _i47.HomeViewModel(gh<_i32.IHomeService>()));
    return this;
  }
}
