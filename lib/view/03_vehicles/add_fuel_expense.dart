...
@RoutePage()
class AddFuelExpensePage extends StatelessWidget {
  const AddFuelExpensePage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: cmnTitleWidget('Add FuelExpense'),
      ),
      body: Padding(
                  ...
                  child: Padding(
                      ...
                      child: Column(children: [
                        ...
                        CmButton(
                          ...
                          loading: vmVehicle.addFuelExpenseResponse.loading,
                          onPressed: () {
                            cmSubmitFn(context);
                          },
                        )
