...
mixin _$SalesModel {
  ...
  @JsonKey(name: 'is_mock_job')
  bool? get isMockJob => throw _privateConstructorUsedError;
  @JsonKey(name: 'job_code')
  String? get jobCode => throw _privateConstructorUsedError;
  @JsonKey(name: 'quoted_by')
  String? get quotedBy => throw _privateConstructorUsedError;
  ...
  int? get jobCardId => throw _privateConstructorUsedError;
  ...
  @JsonKey(name: 'sales_approve_date')
  String? get salesApproveDate => throw _privateConstructorUsedError;
...
class _$SalesModelCopyWithImpl<$Res, $Val extends SalesModel>
  ...
  $Res call({
    ...
    Object? isMockJob = freezed,
    Object? jobCode = freezed,
    Object? quotedBy = freezed,
    ...
    Object? salesApproveDate = freezed,
    ...
    return _then(_value.copyWith(
      ...
      client: freezed == client
          ...
          : client // ignore: cast_nullable_to_non_nullable
              as int?,
      isMockJob: freezed == isMockJob
          ? _value.isMockJob
          : isMockJob // ignore: cast_nullable_to_non_nullable
              as bool?,
      jobCode: freezed == jobCode
          ? _value.jobCode
          : jobCode // ignore: cast_nullable_to_non_nullable
              as String?,
      quotedBy: freezed == quotedBy
          ? _value.quotedBy
          : quotedBy // ignore: cast_nullable_to_non_nullable
              as String?,
      ...
      typeOfWasteStrProfileName: freezed == typeOfWasteStrProfileName
          ...
          : typeOfWasteStrProfileName // ignore: cast_nullable_to_non_nullable
              as dynamic,
      salesApproveDate: freezed == salesApproveDate
          ? _value.salesApproveDate
          : salesApproveDate // ignore: cast_nullable_to_non_nullable
              as String?,
      ...
      jobCard: freezed == jobCard
          ...
          : jobCard // ignore: cast_nullable_to_non_nullable
              as int?,
      jobComments: freezed == jobComments
          ? _value.jobComments
...
class _$SalesModelImpl implements _SalesModel {
  _$SalesModelImpl(
      {this.id,
      this.client,
      @JsonKey(name: 'is_mock_job') this.isMockJob,
      @JsonKey(name: 'job_code') this.jobCode,
      @JsonKey(name: 'quoted_by') this.quotedBy,
      ...
      @JsonKey(name: 'sales_approve_date') this.salesApproveDate,
  ...
  @JsonKey(name: 'job_card')
  final int? jobCard;
  final List<dynamic>? _jobComments;
  @override
  @JsonKey(name: 'job_comments')
  List<dynamic>? get jobComments {
    final value = _jobComments;
    if (value == null) return null;
    if (_jobComments is EqualUnmodifiableListView) return _jobComments;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isMockJob, isMockJob) ||
                other.isMockJob == isMockJob) &&
            (identical(other.jobCode, jobCode) || other.jobCode == jobCode) &&
            (identical(other.quotedBy, quotedBy) ||
                other.quotedBy == quotedBy) &&
            ...
            const DeepCollectionEquality()
                .equals(other.nextService2, nextService2) &&
            ...
            (identical(other.salesApproveDate, salesApproveDate) ||
                other.salesApproveDate == salesApproveDate) &&
