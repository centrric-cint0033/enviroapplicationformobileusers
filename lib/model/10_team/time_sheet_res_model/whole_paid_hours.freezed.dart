...
WholePaidHours _$WholePaidHoursFromJson(Map<String, dynamic> json) {
  return _WholePaidHours.fromJson(json);
}

/// @nodoc
mixin _$WholePaidHours {
  ...
  @JsonKey(ignore: true)
  $WholePaidHoursCopyWith<WholePaidHours> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WholePaidHoursCopyWith<$Res> {
  factory $WholePaidHoursCopyWith(
          WholePaidHours value, $Res Function(WholePaidHours) then) =
      _$WholePaidHoursCopyWithImpl<$Res, WholePaidHours>;
  @useResult
  $Res call(
      {num? sick,
      num? annual,
...
/// @nodoc
class _$WholePaidHoursCopyWithImpl<$Res, $Val extends WholePaidHours>
    implements $WholePaidHoursCopyWith<$Res> {
  _$WholePaidHoursCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WholePaidHoursImplCopyWith<$Res>
    implements $WholePaidHoursCopyWith<$Res> {
  factory _$$WholePaidHoursImplCopyWith(_$WholePaidHoursImpl value,
          $Res Function(_$WholePaidHoursImpl) then) =
      __$$WholePaidHoursImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {num? sick,
...
/// @nodoc
class __$$WholePaidHoursImplCopyWithImpl<$Res>
    extends _$WholePaidHoursCopyWithImpl<$Res, _$WholePaidHoursImpl>
    implements _$$WholePaidHoursImplCopyWith<$Res> {
  __$$WholePaidHoursImplCopyWithImpl(
      _$WholePaidHoursImpl _value, $Res Function(_$WholePaidHoursImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WholePaidHoursImpl(
      sick: freezed == sick
          ? _value.sick
          : sick // ignore: cast_nullable_to_non_nullable
              as num?,
...
/// @nodoc
@JsonSerializable()
class _$WholePaidHoursImpl implements _WholePaidHours {
  _$WholePaidHoursImpl(
      {this.sick,
      this.annual,
  ...
  factory _$WholePaidHoursImpl.fromJson(Map<String, dynamic> json) =>
      _$$WholePaidHoursImplFromJson(json);
  ...
  @override
  String toString() {
    return 'WholePaidHours(sick: $sick, annual: $annual, fullTime: $fullTime, halfTime: $halfTime, otherDays: $otherDays, normalHours: $normalHours, publicHolidays: $publicHolidays, totalHoursWorked: $totalHoursWorked)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WholePaidHoursImplCopyWith<_$WholePaidHoursImpl> get copyWith =>
      __$$WholePaidHoursImplCopyWithImpl<_$WholePaidHoursImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$WholePaidHoursImplToJson(
      this,
    );
  }
}

abstract class _WholePaidHours implements WholePaidHours {
  factory _WholePaidHours(
          {final num? sick,
          final num? annual,
  ...
  factory _WholePaidHours.fromJson(Map<String, dynamic> json) =
      _$WholePaidHoursImpl.fromJson;
