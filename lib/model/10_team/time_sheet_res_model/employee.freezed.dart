...
abstract class $EmployeeCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {num? id, @JsonKey(name: 'employee_id') num? employeeId, String? name});
}
...
class _$EmployeeImpl implements _Employee {
  _$EmployeeImpl(
      {this.id, @JsonKey(name: 'employee_id') this.employeeId, this.name});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, employeeId, name);
...
abstract class _Employee implements Employee {
  factory _Employee(
      ...
      final String? name}) = _$EmployeeImpl;
