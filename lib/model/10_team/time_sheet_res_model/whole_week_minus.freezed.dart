...
WholeWeekMinus _$WholeWeekMinusFromJson(Map<String, dynamic> json) {
  return _WholeWeekMinus.fromJson(json);
}
...
mixin _$WholeWeekMinus {
  ...
  @JsonKey(ignore: true)
  $WholeWeekMinusCopyWith<WholeWeekMinus> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WholeWeekMinusCopyWith<$Res> {
  factory $WholeWeekMinusCopyWith(
          WholeWeekMinus value, $Res Function(WholeWeekMinus) then) =
...
/// @nodoc
class _$WholeWeekMinusCopyWithImpl<$Res, $Val extends WholeWeekMinus>
    implements $WholeWeekMinusCopyWith<$Res> {
  _$WholeWeekMinusCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WholeWeekMinusImplCopyWith<$Res>
    implements $WholeWeekMinusCopyWith<$Res> {
  factory _$$WholeWeekMinusImplCopyWith(_$WholeWeekMinusImpl value,
          $Res Function(_$WholeWeekMinusImpl) then) =
      __$$WholeWeekMinusImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {num? sick,
...
/// @nodoc
class __$$WholeWeekMinusImplCopyWithImpl<$Res>
    extends _$WholeWeekMinusCopyWithImpl<$Res, _$WholeWeekMinusImpl>
    implements _$$WholeWeekMinusImplCopyWith<$Res> {
  __$$WholeWeekMinusImplCopyWithImpl(
      _$WholeWeekMinusImpl _value, $Res Function(_$WholeWeekMinusImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WholeWeekMinusImpl(
      sick: freezed == sick
          ? _value.sick
          : sick // ignore: cast_nullable_to_non_nullable
              as num?,
...
/// @nodoc
@JsonSerializable()
class _$WholeWeekMinusImpl implements _WholeWeekMinus {
  ...
  factory _$WholeWeekMinusImpl.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  String toString() {
    return 'WholeWeekMinus(sick: $sick, annual: $annual, fullTime: $fullTime, halfTime: $halfTime, otherDays: $otherDays, normalHours: $normalHours, publicHolidays: $publicHolidays, totalHoursWorked: $totalHoursWorked)';
  }
  ...
  _$$WholeWeekMinusImplCopyWith<_$WholeWeekMinusImpl> get copyWith =>
      __$$WholeWeekMinusImplCopyWithImpl<_$WholeWeekMinusImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$WholeWeekMinusImplToJson(
      this,
    );
  }
}
