...
_$VehicleModelImpl _$$VehicleModelImplFromJson(Map<String, dynamic> json) =>
    _$VehicleModelImpl(
      ...
      warningSystem: json['warning_system'],
      steering: json['steering'],
      safetyEmergStop: json['safety_emerg_stop'],
      handbreakAlarm: json['handbreak_alarm'],
      ptoVacpump: json['pto_vacpump'],
      horn: json['horn'],
      revAlarmCamera: json['rev_alarm_camera'],
      lightsHead: json['lights_head'],
      lightsTail: json['lights_tail'],
      lightBeacons: json['light_beacons'],
      hazardLight: json['hazard_light'],
      rimsWheelnut: json['rims_wheelnut'],
      coolant: json['coolant'],
      wheels: json['wheels'],
      mirrorWindowscreen: json['mirror_windowscreen'],
      structureBodywork: json['structure_bodywork'],
      wipers: json['wipers'],
      fuelLevelpump: json['fuel_levelpump'],
      fuelLeveltruck: json['fuel_leveltruck'],
      seatSeatbelt: json['seat_seatbelt'],
      parkbrakeTrailer: json['parkbrake_trailer'],
