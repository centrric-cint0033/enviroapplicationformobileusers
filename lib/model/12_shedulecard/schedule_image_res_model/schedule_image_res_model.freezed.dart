...
ScheduleImageResModel _$ScheduleImageResModelFromJson(
    Map<String, dynamic> json) {
  return _ScheduleImageResModel.fromJson(json);
}

/// @nodoc
mixin _$ScheduleImageResModel {
  ...
  String? get departEnviroFacility => throw _privateConstructorUsedError;
  ...
  num? get job => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ScheduleImageResModelCopyWith<ScheduleImageResModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ScheduleImageResModelCopyWith<$Res> {
  factory $ScheduleImageResModelCopyWith(ScheduleImageResModel value,
          $Res Function(ScheduleImageResModel) then) =
      _$ScheduleImageResModelCopyWithImpl<$Res, ScheduleImageResModel>;
  @useResult
  $Res call(
      {num? id,
...
/// @nodoc
class _$ScheduleImageResModelCopyWithImpl<$Res,
        $Val extends ScheduleImageResModel>
    implements $ScheduleImageResModelCopyWith<$Res> {
  _$ScheduleImageResModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ScheduleImageResModelImplCopyWith<$Res>
    implements $ScheduleImageResModelCopyWith<$Res> {
  factory _$$ScheduleImageResModelImplCopyWith(
          _$ScheduleImageResModelImpl value,
          $Res Function(_$ScheduleImageResModelImpl) then) =
      __$$ScheduleImageResModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {num? id,
...
/// @nodoc
class __$$ScheduleImageResModelImplCopyWithImpl<$Res>
    extends _$ScheduleImageResModelCopyWithImpl<$Res,
        _$ScheduleImageResModelImpl>
    implements _$$ScheduleImageResModelImplCopyWith<$Res> {
  __$$ScheduleImageResModelImplCopyWithImpl(_$ScheduleImageResModelImpl _value,
      $Res Function(_$ScheduleImageResModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ScheduleImageResModelImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as num?,
...
/// @nodoc
@JsonSerializable()
class _$ScheduleImageResModelImpl implements _ScheduleImageResModel {
  _$ScheduleImageResModelImpl(
      {this.id,
  ...
  factory _$ScheduleImageResModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$ScheduleImageResModelImplFromJson(json);
  ...
  @override
  @JsonKey(name: 'depart_enviro_facility')
  final String? departEnviroFacility;
  @override
  @JsonKey(name: 'start_job')
  ...
  @override
  String toString() {
    return 'ScheduleImageResModel(id: $id, jobVideo: $jobVideo, client: $client, address: $address, jobType: $jobType, amount: $amount, paidAmount: $paidAmount, amountPaidStatus: $amountPaidStatus, amountTotalPaidStatus: $amountTotalPaidStatus, pendingAmount: $pendingAmount, vehicle: $vehicle, teamEmployees: $teamEmployees, shift: $shift, gallery: $gallery, beforePics: $beforePics, afterPics: $afterPics, comments: $comments, status: $status, tabType: $tabType, quoteId: $quoteId, vehicles: $vehicles, primeVehicleDriver: $primeVehicleDriver, additionalVehicleDriver: $additionalVehicleDriver, latitude: $latitude, longitude: $longitude, frequency: $frequency, wasteTypeStr: $wasteTypeStr, typeOfWasteStrProfileName: $typeOfWasteStrProfileName, jobCardCode: $jobCardCode, startDate: $startDate, startTime: $startTime, endTime: $endTime, image: $image, createdDateTime: $createdDateTime, endDate: $endDate, extractedWasteType: $extractedWasteType, extractedLitresOfWaste: $extractedLitresOfWaste, departEnviroFacility: $departEnviroFacility, startJob: $startJob, finishJob: $finishJob, arriveAtWasteDepot: $arriveAtWasteDepot, departWasteDepot: $departWasteDepot, arriveEnviroFacility: $arriveEnviroFacility, scheduleCompletedMail: $scheduleCompletedMail, completed: $completed, outsourcedJob: $outsourcedJob, purchaseOrderNumber: $purchaseOrderNumber, signatureName: $signatureName, outsourcedCompanyName: $outsourcedCompanyName, activeStatus: $activeStatus, job: $job)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ScheduleImageResModelImpl &&
            ...
            (identical(other.departEnviroFacility, departEnviroFacility) ||
                other.departEnviroFacility == departEnviroFacility) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ScheduleImageResModelImplCopyWith<_$ScheduleImageResModelImpl>
      get copyWith => __$$ScheduleImageResModelImplCopyWithImpl<
          _$ScheduleImageResModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ScheduleImageResModelImplToJson(
      this,
    );
  }
}

abstract class _ScheduleImageResModel implements ScheduleImageResModel {
  factory _ScheduleImageResModel(
      {final num? id,
      @JsonKey(name: 'job_video') final List<dynamic>? jobVideo,
      final String? client,
      final String? address,
      ...
      final num? job}) = _$ScheduleImageResModelImpl;

  factory _ScheduleImageResModel.fromJson(Map<String, dynamic> json) =
      _$ScheduleImageResModelImpl.fromJson;
  ...
  @override
  @JsonKey(name: 'depart_enviro_facility')
  String? get departEnviroFacility;
  @override
  @JsonKey(name: 'start_job')
  String? get startJob;
  @override
