...
import 'before_pic.dart';
import 'prime_vehicle_driver.dart';
import 'team_employee.dart';
import 'vehicle.dart';

part 'schedule_image_res_model.freezed.dart';
part 'schedule_image_res_model.g.dart';

@freezed
class ScheduleImageResModel with _$ScheduleImageResModel {
  factory ScheduleImageResModel({
    num? id,
    ...
    num? job,
  }) = _ScheduleImageResModel;

  factory ScheduleImageResModel.fromJson(Map<String, dynamic> json) =>
      _$ScheduleImageResModelFromJson(json);
}
